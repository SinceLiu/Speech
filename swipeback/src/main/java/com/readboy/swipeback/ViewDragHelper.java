...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.ob.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.ob.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.ob.swipeback.ViewDragHelper.Callback#tryCaptureView(View, int)}
...
//        return false;
     ...
     * {@link com.ob.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
