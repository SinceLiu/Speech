...
class AppCompatTextViewAutoSizeHelper {
    ...
    // Auto-size text type.
    private int mAutoSizeTextType = TextViewCompat2.AUTO_SIZE_TEXT_TYPE_UNIFORM;
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (supportsAutoSizeText()) {
            if (mAutoSizeTextType == TextViewCompat2.AUTO_SIZE_TEXT_TYPE_UNIFORM) {
            ...
            mAutoSizeTextType = TextViewCompat2.AUTO_SIZE_TEXT_TYPE_NONE;
        }
    }
    ...
    void setAutoSizeTextTypeWithDefaults(@TextViewCompat2.AutoSizeTextType int autoSizeTextType) {
        if (supportsAutoSizeText()) {
            switch (autoSizeTextType) {
                case TextViewCompat2.AUTO_SIZE_TEXT_TYPE_NONE:
                    clearAutoSizeConfiguration();
                    break;
                case TextViewCompat2.AUTO_SIZE_TEXT_TYPE_UNIFORM:
                    final DisplayMetrics displayMetrics =
                            mContext.getResources().getDisplayMetrics();
    ...
    private boolean setupAutoSizeUniformPresetSizesConfiguration() {
        ...
        if (mHasPresetAutoSizeValues) {
            mAutoSizeTextType = TextViewCompat2.AUTO_SIZE_TEXT_TYPE_UNIFORM;
